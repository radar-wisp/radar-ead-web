/**
 * modals.js — Modal de liberação/edição de acesso (AcModals).
 * Responsabilidade: abertura/preenchimento do modal, reset, selects de
 * curso/turma/escopo, toggles de regras, seletor de escopo, abas e
 * persistência (salvar). O estado do fluxo (_editCtx, _scopeAtual) é
 * privado deste módulo. Refresh delega a AcessosMod.
 *
 * @module AcModals
 */
...
var AcModals = (() => {
  ...
  return {
    abrirModal, abrirEdit, salvar, tabModal, setScope,
  };
})();
