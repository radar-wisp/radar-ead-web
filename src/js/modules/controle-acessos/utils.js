/**
 * utils.js — Utilitários e configurações compartilhadas (Controle de Acessos).
 * Responsabilidade: helpers de DOM/formatação/toast, badges de status/tipo e
 * resolvers reaproveitados por table, modals e actions.
 *
 * Extraído de controle-acessos.js (modularização — fatia 1).
 *
 * @module AcUtils
 */
...
var AcUtils = (() => {
  ...
  return {
    ...
    resolveStatus, stBadge, nomeAlvo,
    ST, TIPO_LABEL, TIPO_BADGE,
  };
})();
