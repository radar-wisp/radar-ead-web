/**
 * table.js — Stats, filtros, tabela, painéis e menu (AcTable).
 * Responsabilidade: indicadores, chips/badge de filtro, select de cursos,
 * tabela principal, painel de vencimentos (30 dias), histórico de ações e
 * dropdown por linha. Usa helpers de AcUtils e dados de Storage.
 *
 * @module AcTable
 */
...
var AcTable = (() => {
  ...
  const _resolveStatus = AcUtils.resolveStatus;
  ...
  return {
    ...
    renderTabela, _menu, _cm, renderVencimentos, renderHistorico,
  };
})();
