...
var AlunosMod = (() => {
  ...
  // Etapa atual do stepper (0=Dados, 1=Org, 2=Acesso)
  let _step = 0;
  ...
  const _stepValidations = [
    ...
    () => {
      ...
      if (!senha) { _highlightError('mal-senha', 'Informe a senha inicial.'); return false; }
      return true;
    },
  ];
  ...
  /**
   * Avança (+1) ou recua (-1) entre etapas com validação.
  ...
  function _goStep(idx) {
    ...
    // Lines
    document.querySelectorAll('.mal-step-line').forEach((l, i) => {
  ...
  // Mantido para compatibilidade (editar aluno permite navegar livremente)
  function tabModal(idx, btn) { _goStep(idx); }
